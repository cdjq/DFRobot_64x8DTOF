...
void setup() {
  ...
  if (!ok) {
      ...
      #elif DEMO_MODE == 2
        Serial.print("Mode: Single Line (Line: "); Serial.print(LINE_NUM);
        Serial.print(", Start: "); Serial.print(START_POINT);
        Serial.print(", End: "); Serial.print(END_POINT); Serial.println(")");
      #endif
  }
}
